    ...
    return (
        <Popover>
            ...
            <PopoverTrigger asChild>
                <div role="button" className="h-full px-4 py-2 rounded bg-background  border-border min-w-60 flex flex-auto items-center justify-between">
            ...
            <PopoverContent sideOffset="1" align="start" className="p-4 w-80 ">
                <FormField control={form.control} name="roomsCount" 
                    render={({field}) => 
                    <div>
                        <FormItem className="flex items-center justify-between">
                            ...
                            <FormControl>
                                <div className="border rounded border-foreground/50 flex items-center   ">
                                    <Button size="icon" variant="ghost" className="size-10 text-primary hover:text-primary"
                                    onClick={(e)=>{
                                        e.preventDefault();
