        ...
        <Popover open={isPopOverOpen} onOpenChange={setIsPopOverOpen}>
            <PopoverTrigger asChild >
                <div className="flex gap-2 items-center px-4 py-2 rounded bg-background lg:min-w-[360px] h-full">
                    ...
                    />
                    <div role="button"  className={city?"":"opacity-0 pointer-events-none"} 
                    onClick={(e)=>{
                        e.preventDefault();
                        form.setValue("city","");
                    }}
            ...
            <PopoverContent onOpenAutoFocus={(e)=>e.preventDefault()} sideOffset="1" align="start" className="w-[420px] ">
                <div className="p-3 ">
