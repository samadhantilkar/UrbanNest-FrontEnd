...
function HotelMetaDetails({hotel,info}){
    return (
        <>
            <section className="space-y-4">
                ...
                <div className="text-orange-500 bg-orange-50 flex gap-1 p-2 items-center border rounded-sm">
                    ...
                    <p className="text-sm font-medium ">Located Less Than 5 Km From Medanta Hospital | Located 3 Km From Omaxe Celebration Mall</p>
