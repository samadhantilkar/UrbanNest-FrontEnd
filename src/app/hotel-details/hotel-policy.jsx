    ...
    return (
        <section className="space-y-4 ">
            ...
            <div className="space-y-4">
                <div className="flex gap-4 mx-5 h-[100%]">
                    <div className="border-r border-border pr-4">
                        <span className="text-sm">check-in</span>
                        <div className=" mt-3 relative px-4 py-1 border border-border before:absolute before:size-4 
                ...
                <ul className="list-disc list-inside">
                    {hotelPolicy.rules.map((rule,index)=>(
                        <li key={index} className="text-sm text-accent-foreground">
                            {rule}
                        </li>
                    ))}
                </ul>
