        ...
        <article >
            ...
            <div className="flex border border-border p-4">
                ...
                <div className="w-[180px] h-[120px] ">
                    <img className="object-cover size-full rounded-lg" src={photos[0]} alt={photos[0]} />
                </div>
            </div>
            <div className="flex border-x border-b p-4 rounded-b-lg">
                ...
                <Button size="lg" disabled={isSelected} 
                    className={`cursor-pointer h-12 font-semibold gap-1 w-[180px] disabled:opacity-80 uppercase ${isSelected && 'hover:text-destructive text-destructive'}`} variant="outline"> 
                    {!isSelected && <Icon icon="circleCheck" className="fill-green-600 text-white"/>}
                    {isSelected?"Seleted":"Select"} 
                </Button>
            </div>
        </article>
    )
